// =============================================================================
//  校園資訊 APP - version 5.31 (放學方式修復 + 教職員介面優化版)
// =============================================================================
    ...
    const filteredList = activities.filter(item => {
        ...
        (staffDismissalFilter === '家' && item.dismissalMethod === '家');
            ...
            if (staffDateFilter) {
                ...
                // 3. 如果是一筆舊資料 (既沒有 specificDates 也沒有 dayIds)
                else {
                    // 在啟用日期篩選的情況下，舊資料應被視為不匹配
                    matchesDate = false;
                }
            }
